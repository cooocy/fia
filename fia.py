...
if __name__ == '__main__':
    ...
    ls.add_argument('-k', '--keyword', type=str, required=False, help='filtered by KEYWORD contains')
    ...
    w.add_argument('-c', '--content', type=str, required=False,
                   help='the note content you want to write. if not specified, read from the clipboard')
    w.add_argument('-a', '--alias', type=str, required=False, help='the alise of this note')
    w.add_argument('-k', '--keyword', type=str, required=False, nargs='+', help='the keywords of this note')

    args = parser.parse_args()
    print(args)  # TODO Remove print.
